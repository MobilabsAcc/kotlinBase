...
class P5Test {
    ...
    @Test
    fun minesweeperTest(){
        assertEquals(mutableListOf(mutableListOf(1,2,1), mutableListOf(2,1,1), mutableListOf(1,1,1)),
            P5.minesweeper(mutableListOf(mutableListOf(true,false,false), mutableListOf(false,true,false), mutableListOf(false,false,false))))
        assertEquals(mutableListOf(mutableListOf(0,0,0), mutableListOf(0,0,0), mutableListOf(0,0,0)),
            P5.minesweeper(mutableListOf(mutableListOf(false,false,false), mutableListOf(false,false,false), mutableListOf(false,false,false))))
        assertEquals(mutableListOf(mutableListOf(3,5,3), mutableListOf(5,8,5), mutableListOf(3,5,3)),
            P5.minesweeper(mutableListOf(mutableListOf(true,true,true), mutableListOf(true,true,true), mutableListOf(true,true,true))))
        assertEquals(mutableListOf(mutableListOf(3,4,2,1), mutableListOf(5,7,6,3), mutableListOf(3,4,3,1)),
            P5.minesweeper(mutableListOf(mutableListOf(true,true,true,false), mutableListOf(true,true,false,false), mutableListOf(true,true,true,true))))
    }
