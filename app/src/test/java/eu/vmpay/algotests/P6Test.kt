...
class P6Test {
    ...
    fun arrayReplaceTest(){
        assertEquals(mutableListOf(1,2,3,4,5,5),P6.arrayReplace(mutableListOf(1,2,3,4,5,6),6,5))
        assertEquals(mutableListOf(1,2,3,4,5),P6.arrayReplace(mutableListOf(1,2,3,4,5),7,8))
        assertEquals(mutableListOf(1,1,1,1,1,1,1),P6.arrayReplace(mutableListOf(7,7,7,7,7,7,7),7,1))
        assertEquals(mutableListOf(111,123,1233,12344,5678),P6.arrayReplace(mutableListOf(111,123,1233,12344,0),0,5678))
        assertEquals(mutableListOf(1,2,1,2,1,2),P6.arrayReplace(mutableListOf(1,3,1,3,1,3),3,2))
        assertEquals(mutableListOf(-11,22,1123,298,0),P6.arrayReplace(mutableListOf(-11,22,1123,298,0),1,-11))
    }
